        ...
        <article class="">
            ...
            <article class="">
                <p>Desde AUTOCASA queremos mostrarte algunas ideas de las que podrás disfrutar.<br><br>
                    ...
                    <h3>¡¡¡Animate!!! Te esperan miles de kilometros y aventuras.</h3>
                </p>
            </article>
            <div class="sitios">
            <h3 class="tarifaTemporadas">CALETA DE VÉLEZ (MÁLAGA):</h3>

            <p>Caleta de Vélez se encuentra ubicada en la provincia de Málaga a 35 km de de Málaga capital.
                Se trata de una localidad de paisaje costero donde su actividad principal es la pesca.
                El puerto de La Caleta es el puerto pesquero por excelencia de la provincia de Málaga.
            ...
            <p>Tarifa es un municipio español de la provincia de Cádiz. Si viajas a Tarifa podrás disfrutar de múltiples actividades
                ya que su privilegiada posición permite a los visitantes disfrutarde incontables actividades.
                ...
                siendo posible disfrutar de unas espectaculares vistas de África, situada a tan solo 15 km de Tarifa.
                Otra opción es relajarse y disfrutar de las playas de Tarifa disfrutandode las cálidas temperaturas y sus
                aguas cristalinas. La playa de Bolonia se encuentra entre las mejores playas de Cádiz.
            </p>
            </div>
            -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            <div class="sitios">
            ...
            <p> Isleta del moro es una pequeña localidad del Parque Natural Cabo de Gata-Níjar, provincia de Almería.
                ...
                Gata y la isleta o islote a la que hace alusión el nombre del pueblo. Se trata de un pueblo de pescadores
                típico de la zona. De su playa destacan los 2 grandes peñones o formaciones terrestres que son visibles
                desde lejos. Visitar la Isleta del Moro es un excelente lugar para degustar la pesca del mediterráneo.
            </p>
            </div>
            ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            <div class="sitios">
            ...
            <p> Se trata de una localidad española de la provincia de Almería, perteneciente al municipio de Níjar.
                A pesar de ser un pequeño pueblo tiene mucho que ofrecer por sus playas, actividades multiaventura
                y su entorno de salinas de gran valor ecológico.Actualmente es un pueblo de veraneo y se ha convertido,
                en una de las zonas más visitadas del parque.
            </p>
            </div>
            ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            <div class="sitios">
            ...
            <p>El puerto deportivo de Almerimar pertenece al municipio de El Ejido. Está situado en la provincia de Almería
                y es uno de los más grandes puertos deportivos de la costa andaluza. Su privilegiada ubicación y su cálido
                clima durante todo el año lo convierte en el lugar perfecto para la práctica de la vela, windsurf, buceo, pesca, golf, etc.
